...
- **OpenAI 兼容 API Server**：workhorse 作为 API 代理，对外暴露标准 OpenAI 接口
...
| 功能            | ChatGPT | Claude      | Gemini Web | Open WebUI | LobeChat | **workhorse (目标)** |
| --------------- | ------- | ----------- | ---------- | ---------- | -------- | ------------------- |
| 多 Endpoint     | ❌      | ❌          | ❌         | ✅         | ✅       | ✅                  |
| 多模型切换      | ✅      | ✅          | ✅         | ✅         | ✅       | ✅                  |
| 图片上传        | ✅      | ✅          | ✅         | ✅         | ✅       | 🔜 Phase 1          |
...
> **目标定位**：workhorse 的独特定位是 **私有化可部署的全功能 AI 助理工作台**，对标 [Open WebUI](https://github.com/open-webui/open-webui) / [LobeChat](https://github.com/lobehub/lobe-chat)，但更轻量、更易于二次开发。核心竞争力是 **多 Endpoint 聚合 + 本地化部署 + 扩展性**。
